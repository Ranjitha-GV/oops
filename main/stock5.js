...
var data =  fs.readFileSync('/home/d/Desktop/labsfirst/oops/main/stock5.json');//, 'utf-8', function(err,stock)
...
class Account
{
    ...
    buy()
    {
        ...
        fs.writeFile('/home/d/Desktop/labsfirst/oops/main/stock5.json', JSON.stringify(arrayOfObjects), 'utf-8', function(err) {
            if (err) throw err
           console.log('Done!')
  }) 
} 
...
sell()
{
    ...
    for(var k=0;k<arrayOfObjects.stock.length;k++)
    {
        if(arrayOfObjects.stock[k]==null)
        {
            arrayOfObjects.stock.splice(k,1);
        }
    }
        fs.writeFile('/home/d/Desktop/labsfirst/oops/main/stock5.json', JSON.stringify(arrayOfObjects), 'utf-8', function(err) {
            if (err) throw err
