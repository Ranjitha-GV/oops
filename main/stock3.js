...
function inventory()
{
    ...
    {
        case 1:
        console.log("Price per share is: "+jsonStock.stock[0].price);
        ...
        case 2:
        console.log("Price per share is: "+jsonStock.stock[1].price);
        var share = prompt("Please enter the number of shares you want to purchase: ");
        // for(var i=0;i<jsonStock.stock.length;i++)
        // {
        ...
        case 3:
        console.log("Price per share is: "+jsonStock.stock[2].price);
        var share = prompt("Please enter the number of shares you want to purchase: ");
        // for(var i=0;i<jsonStock.stock.length;i++)
        // {
